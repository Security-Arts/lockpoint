...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      "Execution history grouped by person/team",
      "Shareable links",
      "Basic credibility signals (counts, streaks)",
    ],
  },
  {
    name: "Phase 3 — Execution Capital",
    items: [
      "Public execution score",
      "Reliability index",
      "Optional monetary stakes",
      "Access tiers based on execution history",
      "External profile integration",
    ],
    note:
      "Goal: turn consistent follow-through into a measurable trust signal.",
  },
];
    ...
    <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900 dark:bg-black dark:text-zinc-50">
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
          Where Lockpoint is going
        </h1>

        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-zinc-700 dark:text-zinc-200">
          Lockpoint measures execution. Over time, execution becomes capital.
        </p>
        ...
        <div className="mt-8 space-y-4">
          {PHASES.map((p) => (
            <section
              key={p.name}
              className="rounded-3xl border border-zinc-200 bg-white p-6 dark:border-white/10 dark:bg-white/5 sm:p-8"
            >
